...
## Tag Changes (all 47 tracks)
- `TCMP = 1` (Compilation) set on every file
...
|---|---|---|---|
| `Akira The Don - NO SMARTER THAN YOU.mp3` | `Akira The Don;Steve Jobs - NO SMARTER THAN YOU.mp3` | TPE1: `Akira The Don;Steve Jobs` · Genre: `Musivation` | `Musivation/Akira The Don/Singles/` |
| `Loot Bryon Smith - On Point.mp3` | *(unchanged)* | Genre: `Musivation` | `Musivation/Loot Bryon Smith/Spotify Albums/Refined Yet Rebellious/` *(new)* |
| `Loot Bryon Smith - Polarity.mp3` | *(unchanged)* | Genre: `Musivation` | `Musivation/Loot Bryon Smith/Spotify Albums/Refined Yet Rebellious/` *(new)* |
...
| `Katy Perry - Waking Up In Vegas.mp3` | `Artists/Katy Perry/One Of The Boys (15th Anniversary Edition)/` *(new)* |
...
| `Fort Minor - High Road (feat. John Legend).mp3` | `Fort Minor;John Legend - High Road (feat. John Legend).mp3` | `Artists/Fort Minor/The Rising Tied (Deluxe Edition)/` *(new)* |
| `Fort Minor - Welcome.mp3` | *(unchanged)* | `Artists/Fort Minor/The Rising Tied (Deluxe Edition)/` *(new)* |
| `Fort Minor - Where'd You Go (feat. Holly Brook & Jonah Matranga).mp3` | `Fort Minor;Holly Brook;Jonah Matranga - Where'd You Go (feat. Holly Brook & Jonah Matranga).mp3` | `Artists/Fort Minor/The Rising Tied (Deluxe Edition)/` *(new)* |
...
## Miscellaneous Songs
*Filename renamed to include all artists where needed*

| Current Filename | New Filename | Note |
|---|---|---|
...
| `Jimmy Eat World - The Middle.mp3` | *(unchanged)* | |
| `Kevin Rudolf - I Made It (Cash Money Heroes).mp3` | `Kevin Rudolf;Birdman;Jay Sean;Lil Wayne - I Made It (Cash Money Heroes).mp3` | |
| `k-os - I Wish I Knew Natalie Portman.mp3` | `k-os;Saukrates;Nelly Furtado - I Wish I Knew Natalie Portman.mp3` | |
| `Lifehouse - Hanging By A Moment.mp3` | *(unchanged)* | |
| `Maino - All the Above (feat. T-Pain).mp3` | `Maino;T-Pain - All the Above (feat. T-Pain).mp3` | |
| `Mase - All I Ever Wanted.mp3` | *(unchanged)* | |
| `Mase - What You Want (feat. Total).mp3` | `Mase;Total - What You Want (feat. Total).mp3` | |
| `Michelle Branch - All You Wanted (20th Anniversary Edition).mp3` | *(unchanged)* | |
| `Michelle Branch - Everywhere.mp3` | *(unchanged)* | |
| `P-Money - Keep on Calling (feat. Akon).mp3` | `P-Money;Akon - Keep on Calling (feat. Akon).mp3` | |
| `Simply Red - Holding Back the Years (2008 Remaster).mp3` | *(unchanged)* | |
