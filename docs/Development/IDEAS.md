...
- [ ] **XML serialization refactor (prerequisite for Phase 2.5)** - /think analysis 2026-06-03 found design flaws in the XML layer. Do this BEFORE Phase 2.5 to make the cover art schema redesign clean.
  ...
  - **Scope:** TrackXML.cs only. TrackXML tests need updating (behavior unchanged, just method signatures). No behavior changes, no force regen needed.
  - **Note:** Issues 2, 3, 4 resolved - see HISTORY.md. Issue 2 retracted (MP3-path branch is live code). Issues 3 and 4 completed 2026-06-06.
