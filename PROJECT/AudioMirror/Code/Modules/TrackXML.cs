    ...
    internal class TrackXML : Track
        {
            ...
            /// <summary>
            /// Read in a track XML object from an EXISTING XML file
            /// </summary>
            ...
            public TrackXML(string mirrorFilePath)
            {
                ...
                {
                    HandleError("Error occurred while loading EXISTING XML file", mirrorFilePath, ex);
                }
            }


            /// <summary>
            /// Write out a NEW audio XML file from a track tag
            /// </summary>
            ...
            public TrackXML(string mirrorFilePath, TrackTag tag)
            {
                try
                {
                    ...
                    SetElement("TrackNumber", tag.TrackNumber);
                ...
                {
                    HandleError("Error occurred while creating NEW XML file!", mirrorFilePath, ex);
                }
            }
